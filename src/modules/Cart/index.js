...
function Cart() {
  ...
  const handleInc = (id) => {
    const upatedCart = carts.map((item) => {
      if (item.id === id) {
        return {
          ...item,
  ...
  //   const upatedCart = carts.filter(item => item.id !== id)
  //   localStorage.setItem('cart', JSON.stringify(upatedCart))
  //   navigate('/home/cart')
  // }
            ...
            <div id="summary" className="w-1/4 px-8 py-10 bg-white">
              ...
              <div className="py-10">
                ...
                <input
                  ...
                  className="p-2 text-sm w-full bg-gray-200 placeholder-black rounded border-indigo-500 border-2"
                />
              </div>
